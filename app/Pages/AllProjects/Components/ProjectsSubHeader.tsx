...
function MyProjectsText() {
    return <p className="text-[26px] font-bold text-black max-sm:text-[23px] ">My Projects</p>;
  }
  

function SortByButton() {
  return (
    <div className="flex text-[15px] font-semibold gap-3 max-sm:text-[14px] max-sm:gap-1">
